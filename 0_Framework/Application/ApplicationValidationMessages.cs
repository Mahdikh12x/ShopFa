namespace _0_Framework.Application
{
    public class ApplicationValidationMessages
    {
        ...
        public const string WrongUserPass = "نام کاربری یا رمز عبور اشتباه است لطفا دوباره تلاش کنید.";
        public const string EmptyLoginValue = "لطفا نام کاربری و رمز عبور را پر کنید.";
    }
}
